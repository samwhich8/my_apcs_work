...
public class PersonStats
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("average pets: " + averagePets(people));
        System.out.println();
